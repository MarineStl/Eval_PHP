...
<form method="POST" action="?page=ajouter">>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="categorie" placeholder="" name="categorie" value="<?=$_POST['catégorie'] ?? $chaussure->getCategorie()?>">
  </div>
  <div class="form-group">
    <label for="stock">Stock</label>
    <input type="text" class="form-control" id="stock" placeholder="" name="stock" value="<?=$_POST['stock'] ?? $chaussure->getStock()?>">
  </div>
  <div class="form-group">
    <label for="photo">Photo</label>
    <input type="file" class="form-control" id="photo" placeholder="" name="photo" value="<?=$_POST['photo'] ?? $chaussure->getPhoto()?>">
  </div>
